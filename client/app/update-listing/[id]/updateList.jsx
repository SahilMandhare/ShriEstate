...
const updateList = (props) => {
  ...
  useEffect(() => {
    ...
    const previousList = async () => {

        try {

          const response = await fetch("http://localhost:4000/api/lists/list/" + props.id)
  ...
  const submitHandler = async (e) => {
    try {
      ...
      const response = await fetch("http://localhost:4000/api/lists/update/" + list._id, {
        method: "POST",
        headers: {
  ...
  return (
    <>
      <div className="m-5">
        <h1 className="text-2xl text-center font-semibold">Update Listing</h1>
            ...
            <div className="flex flex-wrap">
              ...
              <div className="p-4 flex gap-3 items-center">
                <input
                  ...
                  type="number"
                  onChange={listHandler}
                  value={parseInt(list.regularPrice)}
                />
                <p>Regular Pice</p>
              </div>
